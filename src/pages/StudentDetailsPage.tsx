...
const StudentDetailsPage = ({ onNext, onBack }: { onNext: () => void; onBack: () => void }) => {
  const [students, setStudents] = useState([{ firstName: "", lastName: "", school: "", grade: "", subject: "" }]);
  ...
  const handleAddStudent = () => {
    setStudents([...students, { firstName: "", lastName: "", school: "", grade: "", subject: "" }]);
  };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-1/2 flex flex-col px-8 py-12">
        ...
        <div className="space-y-10 max-w-lg w-full">
          ...
          <button onClick={handleAddStudent} className="text-sm text-green-900 font-medium hover:underline">
            + Add Another Student
          </button>
